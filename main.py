...
""")
tab1, tab2, tab3, tab4= st.tabs(["Data ", "Data Preprocessing", "Modeling", "Implementation"])
# create content
with tab1:
...
with tab3:
    ...
    ('K-NN','Naive Bayes','DecisionTree','MLPClassifier'))
    if algoritma=='K-NN':
        ...
        model = GaussianNB()
        filename='NB2.pkl'
    elif algoritma=='DecisionTree':
        model = tree.DecisionTreeClassifier(criterion="gini")
        filename='DT.pkl'
    elif algoritma=='MLPClassifier':
        clf = MLPClassifier(hidden_layer_sizes=(300,300,300), max_iter=1000, alpha=0.0001,solver='sgd', verbose=10,  random_state=21,tol=0.001)
